...
proc create_root_design { parentCell } {
  ...
  set DINS [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 DINS ]
  set DOUTS [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 DOUTS ]
  ...
  # Create ports
  set int_out [ create_bd_port -dir O int_out ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_3_GPIO [get_bd_intf_ports DINS] [get_bd_intf_pins axi_gpio_3/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_4_GPIO [get_bd_intf_ports DOUTS] [get_bd_intf_pins axi_gpio_4/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_gpio_2/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net axi_gpio_2_ip2intc_irpt [get_bd_ports int_out] [get_bd_pins axi_gpio_2/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
